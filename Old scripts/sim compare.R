...
dailypred = data.frame(run = rep(0,10), iter = rep(0,10), day = rep(0,10), number = rep(0,10), loops = rep(0,10), cap = rep(0,10), ars = rep(0,10), gud = rep(0,10), baseline = rep(0,10), lag = rep(0,10), minprev = rep(0,10), treat = treatments, srain = rain, area = s, seeds = rep(0,10), pred = rep(0,10), actpred = rep(0,10), actseeds = rep(0,10), indexp = rep(100,10))
temp = dailypred
ru = 0
