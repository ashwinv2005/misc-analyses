...
data = read.csv("C:/Ashwin/CSV/Veg/intpatchjv18.csv")
...
com = compare_distributions(exp,lnorm) # all combinations as required
...
ggp + 
  ...
  scale_x_log10(breaks = c(1,10,100,1000,10000))+ # to scale the x-axis logarithmically. Remove if not required.
...
com = compare_distributions(exp,lnorm)
com$test_statistic
com$p_two_sided 
com$p_one_sided
